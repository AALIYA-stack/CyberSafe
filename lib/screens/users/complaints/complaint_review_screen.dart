  ...
  Future<void> _submitComplaint() async {
    ...
    try {
      ...
      final complaint = Complaint(
        // Service generates actual ID.
        id: '',

        // IMPORTANT:
        // Firebase Auth UID is used here.
        ...
        platform: widget.platform.trim(),

        location: widget.location.trim(),

        suspect: widget.suspect.trim(),
      ...
      if (complaintId.trim().isEmpty) {
        ...
        final serviceError =
            ComplaintService.instance.lastError;
      ...
      // Pehle yahan:
      //
      // getMyComplaintById(complaintId)
      //
      // call ho raha tha.
      //
      // Ab zaroorat nahi.
      //
      // Complaint successfully Firestore mein save ho chuki
      // hai, isliye local complaint object mein generated
      // complaint ID add karke success screen open karenge.
      //
      // Is se submit ke baad unnecessary Firestore READ
      // nahi hogi.
      // ======================================================
