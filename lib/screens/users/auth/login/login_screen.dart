...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // --------------------------------------------------------
      // ONLY NORMAL USER CAN ENTER USER APP
      // --------------------------------------------------------
                ...
                AuthSlideAnimation(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Login to your CyberSafe account to continue.',
                        style: TextStyle(
                          fontSize: 14,
                          height: 1.5,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Never share your password, OTP or account credentials with anyone.',
                            style: TextStyle(
                              fontSize: 11.5,
                              height: 1.45,
                              color: AppColors
